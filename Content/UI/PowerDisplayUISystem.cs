            ...
            if (UIIndex != -1)
            {
                layers.Insert(UIIndex, new LegacyGameInterfaceLayer(
                    ...
                    delegate
                    {
                        ...
                        Texture2D texture = Textures.EnergyBar.Value;
                        ...
                        Main.spriteBatch.Draw(Textures.Bloom.Value, position - (frame.Size() / 2) + (frame2.Size() / 2), null, (Color.LightGoldenrodYellow * 0.5f * DisplayValue * Timer) with { A = 0 }, 0f, Textures.Bloom.Size() / 2f, (frame.Size() / Textures.Ball.Size()) * 1.4f, SpriteEffects.None, 0f);
